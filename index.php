...
Finish here.-->
  ...
  <div class="container-fluid" id="containerStyle">
    <div class="p-3 my-3 border border-info rounded">
      <h2>Assessment Two</h2>
      <p class="lead">Name: Kristiin Tribbeck<br>
        ID: 30045325<br>
        Assessment details: This website utilises the Bootstrap framework to display resources for leadership skills.
        The knowledge base data is hosted on a MySQL server which populates the various web pages. </p>
    </div>
  </div>
  <footer>
    <div class="row">
